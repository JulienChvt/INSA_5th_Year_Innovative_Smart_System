...
public class Model {
	...
	/*	op = new Op();
		...
		op.setName("YELLOW");
		op.setHref(new Uri(prefix + "?on=true&bri=254&sat=254&hue="+HueUtil.getHue("YELLOW")+"&id="+appId));
		op.setIs(new Contract("execute"));
		obj.add(op);
		...
		op.setName("Low-Bright-RED");
		op.setHref(new Uri(prefix + "?on=true&bri=150&sat=254&hue="+HueUtil.getHue("RED")+"&id="+appId));
		op.setIs(new Contract("execute"));
		obj.add(op);
	*/	
